...
class Curso {
    ...
    init(_ documentID:String, _ nombre:String,_ nombreProfesor:String,_ semestre:String, _ grupos:[DocumentReference],_ salones:[DocumentReference],_ metodologia:DocumentReference) {
