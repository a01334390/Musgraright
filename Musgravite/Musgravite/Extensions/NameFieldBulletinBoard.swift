...
class NameFieldBulletinPage: BLTNPageItem {
    @objc public var nameField: UITextField!
    @objc public var surField: UITextField!
    @objc public var textInputHandler: ((BLTNActionItem, String?) -> Void)? = nil
    
    override func makeViewsUnderDescription(with interfaceBuilder: BLTNInterfaceBuilder) -> [UIView]? {
        nameField = interfaceBuilder.makeTextField(placeholder: "Borreguito", returnKey: .done, delegate: self)
...
extension NameFieldBulletinPage: UITextFieldDelegate {
